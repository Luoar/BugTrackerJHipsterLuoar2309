...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("ch.luoar.bugtrackerluoar2309.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("ch.luoar.bugtrackerluoar2309.security.DomainUserDetailsService", "createSpringSecurityUser");
